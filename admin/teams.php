...
<div class="row">
    ...
    <div class="col-md-8">
        ...
        <tbody><?php foreach($teams as $t): ?>
            <tr><td><img src="<?php echo SITE_URL; ?>/uploads/<?php echo e($t['logo']); ?>" width="40"></td><td><?php echo e($t['name_en']); ?></td><td><button class="btn btn-sm btn-info" onclick='editTeam(<?php echo json_encode($t); ?>)'>Edit</button></td></tr>
