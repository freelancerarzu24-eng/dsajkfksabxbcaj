    ...
    <div class="col-md-8">
        <table class="table bg-white">
            ...
            <tbody>
                ...
                <tr><td><img src="<?php echo SITE_URL; ?>/uploads/<?php echo e($p['logo']); ?>" width="40"></td><td><?php echo e($p['name']); ?></td><td><?php echo e($p['url']); ?></td><td><button class="btn btn-sm btn-info" onclick='editO(<?php echo json_encode($p); ?>)'>Edit</button></td></tr>
                <?php endforeach; ?>
            </tbody>
        </table>
    </div>
